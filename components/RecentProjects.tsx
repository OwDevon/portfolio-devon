...
const RecentProjects = () => {
  return (
    <div className='py-20' id="projects">
        ...
        <div className='flex flex-wrap items-center justify-centerp-4 gap-x-24 gap-y-8 mt-10'>
                        ...
                        <div className='flex items-center justify-between mt-7 mb-3'>
                            <div className='flex items-center'>
                                {iconLists.map((icon, index) => (
                                    <div key={icon} className='border rounded-full bg-black lg:w-10 lg:h-10 w-8 h-8 flex justify-center' style={{ transform: `translateX(-${5 * index * 2}px)`}}>
